...
import ytImg from "@/assets/img/tasks/yt.png";
import calendarImg from "@/assets/img/tasks/calendar.png";
import instaImg from "@/assets/img/tasks/insta.png";
import tgImg from "@/assets/img/tasks/tg.png";
import coinImg from "@/assets/img/tasks/coin.png";
...
<template>
  ...
  ></modal-reward-window>
  <daily-rewards
    v-if="isModalDailyOpen"
    :activeDays="activeDays"
    @close="isModalDailyOpen = false"
    @claim="claim"
  ></daily-rewards>
</template>
